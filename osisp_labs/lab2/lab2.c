...
int main(int argc, char *argv[])
{
    if (argc < 3)
    {
        printf("l2_v10.c: Wrong number of arguments!\n");
        return 1;
    }
    
    int error = mkdir(argv[3], 0700);
    
    if (error == -1)
    {
        printf("l2_v10.c: Can't create such directory.\n");
        return 1;
    }
